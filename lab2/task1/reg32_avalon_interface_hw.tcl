...
add_fileset_file reg_avalon_interface.v VERILOG PATH reg_avalon_interface.v TOP_LEVEL_FILE
...
add_fileset_file reg32.v VERILOG PATH reg32.v
add_fileset_file reg_avalon_interface.v VERILOG PATH reg_avalon_interface.v
