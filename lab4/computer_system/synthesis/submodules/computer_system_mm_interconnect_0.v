...
module computer_system_mm_interconnect_0 (
	...
	wire   [29:0] onchip_sram_s1_agent_m0_address;                        // Onchip_SRAM_s1_agent:m0_address -> Onchip_SRAM_s1_translator:uav_address
	...
	wire  [125:0] onchip_sram_s1_agent_rf_source_data;                    // Onchip_SRAM_s1_agent:rf_source_data -> Onchip_SRAM_s1_agent_rsp_fifo:in_data
	...
	wire  [125:0] onchip_sram_s1_agent_rsp_fifo_out_data;                 // Onchip_SRAM_s1_agent_rsp_fifo:out_data -> Onchip_SRAM_s1_agent:rf_sink_data
	...
	wire  [124:0] onchip_sram_s1_agent_rp_data;                           // Onchip_SRAM_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [124:0] onchip_sram_s1_burst_adapter_source0_data;              // Onchip_SRAM_s1_burst_adapter:source0_data -> Onchip_SRAM_s1_agent:cp_data
	...
	wire  [124:0] router_002_src_data;                                    // router_002:src_data -> Onchip_SRAM_s1_rsp_width_adapter:in_data
	...
	wire  [232:0] onchip_sram_s1_rsp_width_adapter_src_data;              // Onchip_SRAM_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [232:0] cmd_mux_src_data;                                       // cmd_mux:src_data -> Onchip_SRAM_s1_cmd_width_adapter:in_data
	...
	wire  [124:0] onchip_sram_s1_cmd_width_adapter_src_data;              // Onchip_SRAM_s1_cmd_width_adapter:out_data -> Onchip_SRAM_s1_burst_adapter:sink0_data
